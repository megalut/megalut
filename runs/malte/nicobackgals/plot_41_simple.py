...
megalut.plot.hist.hist(ax, cat, Feature("pre_s1w", rea="all"))

ax = fig.add_subplot(2, 3, 2)
megalut.plot.hist.hist(ax, cat, Feature("pre_s2w", rea="all"))

ax = fig.add_subplot(2, 3, 4)
megalut.plot.scatter.scatter(ax, cat, Feature("pre_s1w", rea=-20), Feature("adamom_logflux", rea=-20), sidehists=True)

ax = fig.add_subplot(2, 3, 5)
megalut.plot.scatter.scatter(ax, cat, Feature("pre_s2w", rea=-20), Feature("adamom_logflux", rea=-20), sidehists=True)
...
adamom_flux = Feature("adamom_flux", rea=wplotrea)
adamom_sigma = Feature("adamom_sigma", rea=wplotrea)
adamom_g2 = Feature("adamom_g2", rea=wplotrea)
adamom_rho4 = Feature("adamom_rho4",  rea=wplotrea)


tru_s1 = Feature("tru_s1", nicename=r"$g_1^{\mathrm{true}}$")
tru_s2 = Feature("tru_s2", nicename=r"$g_2^{\mathrm{true}}$")

pre_s1_bias = Feature("pre_s1_bias", -resr, resr)
pre_s2_bias = Feature("pre_s2_bias", -resr, resr)
